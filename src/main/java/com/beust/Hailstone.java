...
public class Hailstone {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Sequence for 27 has " + sequence27.size()
        + " elements: " + sequence27);
    ...
    // Simple way
    {
      ...
      System.out.println("Method 1, number " + highestNumber
          + " has the longest sequence, with a length of " + highestCount);
    ...
    // More memory efficient way
    {
      ...
      System.out.println("Method 2, number " + highestNumber
          + " has the longest sequence, with a length of " + highestCount);
      System.out.println("Time: " + (System.currentTimeMillis() - start));
    }
    ...
    // Efficient for analyzing all sequences
    {
      ...
      System.out.println("Method 3, number " + highestNumber
          + " has the longest sequence, with a length of " + highestCount);
      System.out.println("Time: " + (System.currentTimeMillis() - start));
    }
    return;
